...
public class Parser {
    ...
    /**
     * Abre el archivo y se prepara para convertirlo
     * @param fileIn
     */
        ...
        if (arithmeticCmds.contains(segs[0])){
            ...
            if (argType == PUSH || argType == POP || argType == FUNCTION || argType == CALL){
                ...
                try {
                    ...
                    throw new IllegalArgumentException("falla en argumento 2!");
    ...
    /**
     * retorna el primer argumento del comando actual
     * Cuando es aritmetico se devuelve a si mismo
     * @return
     */
    public String arg1(){
        ...
        if (commandType() != RETURN){
            ...
            throw new IllegalStateException("No se puede obtener el primer argumento de un tipo RETURN");
    ...
    /**
     * retorna el segundo argumento del comando actual
     * @return
     */
    public int arg2(){
        ...
        if (commandType() == PUSH || commandType() == POP || commandType() == FUNCTION || commandType() == CALL){
            ...
            throw new IllegalStateException("no se puede obtener el segundo argumento");
